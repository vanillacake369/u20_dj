                ...
                <form action="action/auth/auth_password_update.php" method="post" class="form">
                    ...
                    <div class="changePwFormArea">
                        <div class="changePwInputArea">
                            <input placeholder="비밀번호" type="password" name="pw" id="pw" value="" minlength="8" maxlength="32" required="" onkeyup="check();" />
                        </div>
                        <div class="changePwInputArea">
                            <input placeholder="비밀번호 재확인" type="password" name="cpassword" id="cpassword" value="" minlength="8" maxlength="32" required="" onkeyup="check();" />
                        </div>
                        <div></div>
                    </div>
