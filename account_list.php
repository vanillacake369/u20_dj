                    ...
                    <form action="" name="judge_searchForm" method="get" class="searchForm pageArea">
                        ...
                        <div class="selectArea defaultSelectArea">
                            <div class="search">
                                ...
                                <input type="text" id="search_user" class="defaultSearchInput" name="search_user" placeholder="검색어를 입력해주세요" maxlength="30" value="<?php echo isset($searchValue) ? $searchValue : ''; ?>">
                                <button name="search" value="search" class="defaultSearchBth" type="submit" title="검색"><i class="xi-search"></i></button>
                            </div>
                        </div>
                    </form>
                </div>
                    ...
                    <tbody class="table_tbody entry_table">
                        ...
                        if (authCheck($db, "authAccountsDelete")) {
                            if (isset($_POST["admin_delete"])) {
                                ...
                                echo "<script>location.href='./account_list.php';</script>";
                            }
                        }
                        ?>
                    </tbody>
