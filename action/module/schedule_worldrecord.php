 ...
 function world($db, $athlete, $new, $schedule_sports,$record)
 {
    if ($new == 'y') {
        ...
        if(($newathletics[0]??null)==='w'){
                ...
                echo '><input placeholder="" type="text" name="newrecord[]" class="input_text" value="세계신기록';
                echo '" maxlength="100" readonly/></td>';
        }else if(($newathletics[0]??null)==='u'){
                echo '<td rowspan=';
                overall($schedule_sports);
                echo '><input placeholder="" type="text" name="newrecord[]" class="input_text" value="세계U20신기록';
                echo '" maxlength="100" readonly/></td>';
        }else if(($newathletics[0]??null)==='a'){
                echo '<td rowspan=';
                overall($schedule_sports);
                echo '><input placeholder="" type="text" name="newrecord[]" class="input_text" value="아시아신기록';
                echo '" maxlength="100" readonly/></td>';
        }else if(($newathletics[0]??null)==='s'){
                echo '<td rowspan=';
                overall($schedule_sports);
                echo '><input placeholder="" type="text" name="newrecord[]" class="input_text" value="아시아U20신기록';
                echo '" maxlength="100" readonly/></td>';
        }else if(($newathletics[0]??null)==='c'){
                echo '<td rowspan=';
                overall($schedule_sports);
                echo '<input placeholder="" type="text" name="newrecord[]" class="input_text" value=">대회신기록';
                echo '" maxlength="100" readonly/></td>';
        }else{
                echo '<td rowspan=';
                overall($schedule_sports);
                echo '><input placeholder="" type="text" name="newrecord[]" class="input_text" value="" maxlength="100" readonly/></td>';
        }
    } else {
        echo '<td rowspan=';
