<?php
    ...
    // echo $starttime;
$db->query("update list_record set record_start ='" . $starttime . "' where record_sports='$sports' and record_gender='$gender' and record_round='$round' and record_group='$heat'");
// echo"update list_record set record_start ='" . $starttime . "' where record_sports='$name' and record_gender='$gender' and record_round='$round' and record_group='$heat'";
