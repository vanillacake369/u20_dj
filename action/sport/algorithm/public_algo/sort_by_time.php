...
{
    $player1_record = intval(str_replace(array('.', ':', ';'), '', $player1_data["record_official_record"]));
    $player2_record = intval(str_replace(array('.', ':', ';'), '', $player2_data["record_official_record"]));
