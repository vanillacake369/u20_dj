  ...
  static animationShowPrevRank(key) {
    document.addEventListener("keydown", (e) => {
      if (e.code === `Key${key.toUpperCase()}`) {
        ...
        let NUM = j;
        let count = 0;
        if (parseInt(now_page.innerText) > 1)
          now_page.innerText = parseInt(now_page.innerText) - 1;
        function print() {
          if (wrapperLank[NUM].innerText === "") {
            count = 8;
          } else {
  ...
  static animationShowNextRank(key) {
    document.addEventListener("keydown", (e) => {
      if (e.code === `Key${key.toUpperCase()}`) {
        ...
        let NUM = j;
        let count = 0;
        if (parseInt(now_page.innerText) < MAX_LENGTH/8)
          now_page.innerText = parseInt(now_page.innerText) + 1;
        function print() {
          if (wrapperLank[NUM].innerText === "") {
            count = 8;
  ...
  static nonAnimationShowPrevRank(key) {
    document.addEventListener("keydown", (e) => {
      if (e.code === `Key${key.toUpperCase()}`) {
        ...
        let NUM = j;
        let count = 0;
        if (parseInt(now_page.innerText) > 0)
          now_page.innerText = parseInt(now_page.innerText) - 1;
        function print() {
          if (wrapperLank[NUM].innerText === "") {
            count = 8;
