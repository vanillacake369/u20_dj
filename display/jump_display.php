...
<body>
    <div class="all">
        ...
        for ($k = 0; $k < $bnt; $k++) {
            $q = $k + 1 ?>
            <button type="button" onclick="location.href='./jump_display.php?schedule_sports=<?php echo $schedule_sports; ?>&schedule_round=<?php echo $schedule_round; ?>&schedule_group=<?php echo $schedule_group; ?>&schedule_gender=<?php echo $schedule_gender; ?>&schedule_id=<?php echo $schedule_id; ?>&page=<?php echo $j; ?>&trial=<?php echo $q ?>'">TRIAL
                <?php echo $q; ?></button>
        <?php
        }
        ?>
