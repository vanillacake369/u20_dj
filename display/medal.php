...
<body>
    ...
    <button type="button" onclick="location.href='./medal.php?schedule_sports=<?php echo $schedule_sports; ?>&schedule_round=<?php echo $schedule_round; ?>&schedule_group=<?php echo $schedule_group; ?>&schedule_gender=<?php echo $schedule_gender; ?>&schedule_id=<?php echo $schedule_id; ?>&page=3'">동메달</button>
    <button type="button" onclick="location.href='./medal.php?schedule_sports=<?php echo $schedule_sports; ?>&schedule_round=<?php echo $schedule_round; ?>&schedule_group=<?php echo $schedule_group; ?>&schedule_gender=<?php echo $schedule_gender; ?>&schedule_id=<?php echo $schedule_id; ?>&page=2'">은메달</button>
    <button type="button" onclick="location.href='./medal.php?schedule_sports=<?php echo $schedule_sports; ?>&schedule_round=<?php echo $schedule_round; ?>&schedule_group=<?php echo $schedule_group; ?>&schedule_gender=<?php echo $schedule_gender; ?>&schedule_id=<?php echo $schedule_id; ?>&page=1'">금메달</button>
    </br>
