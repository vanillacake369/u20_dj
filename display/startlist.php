...
<body>
    <div>
        ...
        if ($num > 1) {
            for ($i = 0; $i < $num; $i++) {
                $j = $i + 1; ?>
                <button type="button" onclick="location.href='./startlist.php?schedule_sports=<?php echo $schedule_sports; ?>&schedule_round=<?php echo $schedule_round; ?>&schedule_group=<?php echo $schedule_group; ?>&page=<?php echo $j; ?>&schedule_gender=<?php echo $schedule_gender; ?>&schedule_id=<?php echo $schedule_id; ?>'">page
                    <?php echo $j; ?></button>
        <?php
            }
        } ?>
