...
<body>
    <div class="all">
        ...
        <button type="button"
            onclick="location.href='./throw_display.php?schedule_sports=<?php echo $schedule_sports;?>&schedule_round=<?php echo $schedule_round;?>&schedule_group=<?php echo $schedule_group;?>&schedule_gender=<?php echo $schedule_gender;?>&schedule_id=<?php echo $schedule_id;?>&page=<?php echo $j;?>&trial=1'">TRIAL
            1</button>
        <button type="button"
            onclick="location.href='./throw_display.php?schedule_sports=<?php echo $schedule_sports;?>&schedule_round=<?php echo $schedule_round;?>&schedule_group=<?php echo $schedule_group;?>&schedule_gender=<?php echo $schedule_gender;?>&schedule_id=<?php echo $schedule_id;?>&page=<?php echo $j;?>&trial=2'">TRIAL
            2</button>
        <button type="button"
            onclick="location.href='./throw_display.php?schedule_sports=<?php echo $schedule_sports;?>&schedule_round=<?php echo $schedule_round;?>&schedule_group=<?php echo $schedule_group;?>&schedule_gender=<?php echo $schedule_gender;?>&schedule_id=<?php echo $schedule_id;?>&page=<?php echo $j;?>&trial=3'">TRIAL
            3</button>
        <button type="button"
            onclick="location.href='./throw_display.php?schedule_sports=<?php echo $schedule_sports;?>&schedule_round=<?php echo $schedule_round;?>&schedule_group=<?php echo $schedule_group;?>&schedule_gender=<?php echo $schedule_gender;?>&schedule_id=<?php echo $schedule_id;?>&page=<?php echo $j;?>&trial=4'">TRIAL
            4</button>
        <button type="button"
            onclick="location.href='./throw_display.php?schedule_sports=<?php echo $schedule_sports;?>&schedule_round=<?php echo $schedule_round;?>&schedule_group=<?php echo $schedule_group;?>&schedule_gender=<?php echo $schedule_gender;?>&schedule_id=<?php echo $schedule_id;?>&page=<?php echo $j;?>&trial=5'">TRIAL
            5</button>
        <button type="button"
            onclick="location.href='./throw_display.php?schedule_sports=<?php echo $schedule_sports;?>&schedule_round=<?php echo $schedule_round;?>&schedule_group=<?php echo $schedule_group;?>&schedule_gender=<?php echo $schedule_gender;?>&schedule_id=<?php echo $schedule_id;?>&page=<?php echo $j;?>&trial=6'">TRIAL
            6</button>
        </br>
