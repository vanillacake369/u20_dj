...
<body>
    <div class="container">
        <div class="titleBox">
            <div class="titleArea">
                <p class="title"><?=$schedule_gender=='m'?"Men's":($schedule_gender=='f'?"Women's":"Mixed")?> </p>
                <p class="title"><?=$schedule_name?></p>
                <p class="recordType">
                    <?=$schedule_result=='o'?'Official Result':($schedule_result=='l'?'Live Result':'Start List')?></p>
            </div>
            <p class="round">1st Round</p>
            <p class="roundDetail">1 / 1</p>
            <p class="windSpeed">Wind Speed</p>
            <p class="windSpeedValue"><?=htmlspecialchars($row2["record_wind"])?>m/s</p>
            <p class="page">Page 1 / 1</p>
            <?
                echo '<div class="pictogram" style="background: url(assets/images/U20_pictogram/';
                echo $schedule_gender=='f'?"female/":"male/";
