            ...
            <div class="MainRank athleteList defaultList">
                        ...
                        <div class="selectArea defaultSelectArea">
                            ...
                            <div class="search">
                                ...
                                <input type="text" id="search" class="defaultSearchInput" name="athlete_name"
                                    placeholder="이름을 입력해주세요" maxlength="30" value="<? echo isset($searchValue["
                                    athlete_name"]) ? $searchValue["athlete_name"] : '' ; ?>">
                                <button name="search" value=search type="submit" class="defaultSearchBth" title="검색"><i
                ...
                <table class="box_table">
                    ...
                    <thead class="table_head entry_table">
                        <tr>
                            ...
                            <th scope="col"><a
                                    href="<?= Get_Sort_Link("region", $pageValue, $link, $orderValue) ?>">지역</a></th>
                            <th scope="col"><a
                    ...
                    <tbody class="table_tbody entry_table">
                        <?php
                            ...
                            while ($row = mysqli_fetch_array($result)) {
                                ...
                                // 참가자 상세 보기
                                echo "<td>";
                                echo "<input type='button' onclick=" . "\"createPopupWin('entry_athlete_info.php?id=" . $row["athlete_id"] . "'" . ",'상세내용 보기',1100,900);\"" . "value='보기' class='BTN_DarkBlue defaultBtn'>";
                                echo "</td>";
                                // 참가자 수정
                                echo "<td>";
                                if (authCheck($db, "authEntrysUpdate")) { 
                                    echo "<input type='button' onclick=" . "updatePop(" . $row["athlete_id"] . ",'athlete_id',\"entry_athlete_modify.php\")" . " value='수정' class='BTN_Blue defaultBtn'>";
                                }
                                echo "</td>";
                                // 참가자 삭제
                                if (authCheck($db, "authEntrysDelete")) { 
                ...
                <div class="playerRegistrationBtnArea">
                    <div class="ExcelBtn IDBtn">
                        <button type="button" class="defaultBtn ID_Print BIG_btn2"
                            onclick="issueId('./entry_athlete_issue.php','athlete_id');">ID발급</button>
                    ...
                    <div class="registrationBtn">
                        <button type="button" class="defaultBtn BIG_btn BTN_Blue"
                            onclick="createPopupWin('./entry_athlete_input.php','등록', 1100, 900);">등록</button>
                    </div>
                </div>
                <div class="page">
