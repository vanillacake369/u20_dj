                                ...
                                <span class="full_span">경기장 내 접근 허용</span>
                                    <div class="full_div">
                                        <label><input type="checkbox" name="athlete_sector[]" value="0" id="All Area"><span>경기장 내 전
                                            구역</span></label>
                                        <label><input type="checkbox" name="athlete_sector[]" value="1"
                                            id="Competition Area(FOP)"><span>경기구역</span></label>
                                        <label><input type="checkbox" name="athlete_sector[]" value="2"
                                            id="Warm-up Area"><span>선수준비구역</span></label>
                                        <label><input type="checkbox" name="athlete_sector[]" value="3"
                                            id="Administration & Operation zone"><span>경기운영구역
                                            zone</span></label>
                                        <label><input type="checkbox" name="athlete_sector[]" value="4"
                                            id="International Officials' Zone"><span>국제임원 업무구역</span>
                                        <label><input type="checkbox" name="athlete_sector[]" value="5"
                                            id="VIP Area"><span>VIP구역(3F)</span></label>
                                        <label><input type="checkbox" name="athlete_sector[]" value="6"
                                            id="Mixed Zone"><span>공동취재구역</span></label>
                                        <label><input type="checkbox" name="athlete_sector[]" value="7"
                                            id="PEA(Post Event Area)"><span>경기 후 구역</span></label>
                                        <label><input type="checkbox" name="athlete_sector[]" value="8"
