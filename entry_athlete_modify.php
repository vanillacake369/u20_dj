                        ...
                        <div>
                            ...
                            <ul class="UserDesc Participant_list">
                                ...
                                <li class="row input_row row_item row_date">
                                    <span>생년월일</span>
                                    <input type="number" value=<?php echo htmlspecialchars($birth[0]) ?> name="athlete_birth_year" class="input_text_row_b" maxlength="4" oninput="maxLengthCheck(this)" required>
                                    <input type="number" value=<?php echo htmlspecialchars($birth[1]) ?> name="athlete_birth_month" class="input_text_row_b" maxlength="2" oninput="maxLengthCheck(this)" required>
                                    <input type="number" value=<?php echo htmlspecialchars($birth[2]) ?> name="athlete_birth_day" class="input_text_row_b" maxlength="2" oninput="maxLengthCheck(this)" required>
                                </li>
                                <li class="row input_row row_item">
                                    <span>나이</span>
                                    <input type="number" maxlength="2" oninput="maxLengthCheck(this)" name="athlete_age" id="athlete_age" value="<?= htmlspecialchars($row["athlete_age"]) ?>" placeholder="나이를 입력해 주세요" required />
                                </li>
                                <li class="row">
                                    <span>이미지 변경</span>
                                ...
                                <li class="row input_row row_item">
                                    <span>등번호</span>
                                    <input type="number" name="athlete_bib" id="athlete_bib" value="<?php echo $row["athlete_bib"] ?>" placeholder="등번호를 입력해 주세요" required maxlength="5" oninput="maxLengthCheck(this)"/>
                                </li>
                            </ul>
                        </div>
                    </div>
