    ...
    <div class="container">
        <div class="athlete">
            ...
            <div class="UserProfile">
                ...
                <form action="./action/module/athlete_update.php" method="post" class="form"
                    enctype="multipart/form-data">
                    <div class="UserProfile_modify Participant_img ptp_img">
                        <div>
                            <img src=<? echo "./assets/img/athlete_img/" . $row["athlete_profile"] ?>
                            alt="avatar" />
                        </div>
                        <div>
                            ...
                            <ul class="UserDesc Participant_list">
                                ...
                                <li class="row modify_input">
                                    <span>국가</span>
                                    <select class="d_select" name="athleteCountry" id="athlete_country">
                                ...
                                <li class="row">
                                    <span>지역</span>
                                    <input type="text" name="athlete_region" id="athlete_region"
                                        value=<?php echo htmlspecialchars($row["athlete_region"]) ?> />
                                </li>
                                <li class="row">
                                    <span>소속</span>
                                    <input type="text" name="athlete_division" id="athlete_division"
                                        value=<?= htmlspecialchars($row["athlete_division"]) ?>
                                        class="input_text_row" />
                                </li>
                                <li class="row modify_input">
                                    <span>성별</span>
                                    <select name="gender" id="athlete_gender" title="성별" required>
                                ...
                                <li class="row input_row row_item row_date">
                                    ...
                                    <input type="text" value=<?php echo htmlspecialchars($birth[0]) ?>
                                        name="athlete_birth_year" class="input_text_row_b">
                                    <input type="text" value=<?php echo htmlspecialchars($birth[1]) ?>
                                        name="athlete_birth_month" class="input_text_row_b">
                                    <input type="text" value=<?php echo htmlspecialchars($birth[2]) ?>
                                        name="athlete_birth_day" class="input_text_row_b">
                                </li>
                                <li class="row">
                                    <span>이미지 변경</span>
                                    <input type="file" name="athlete_imgFile" />
                                </li>
                ...
                <div class="modify_enter">
                    ...
                    <ul class="modify_checkList">
                        <?php
                                        for ($value = 1; $value <= count($sport_dic); $value++) {
                                            echo "<li><label>";
                                            echo '<input type="checkbox" name="athlete_schedules[]"' . 'value="' . key($sport_dic) . '"' . 'id="' . "attendance_" . key($sport_dic) . '"/>';
                                            echo "<span>" . current($sport_dic) . "</span>";
                                            echo "</label></li>";
                                            next($sport_dic);
                                        }
