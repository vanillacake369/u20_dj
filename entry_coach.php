            ...
            <div class="MainRank coachList defaultList">
                ...
                <div class="searchArea">
                    <form action="" name="judge_searchForm" method="get" class="searchForm pageArea">
                        ...
                        <div class="selectArea defaultSelectArea">
                            ...
                            <div class="search">
                                <form action="" class="searchForm" name="coach_searchForm" method="get"
                                    ...
                                    <input type="text" id="search" class="defaultSearchInput" name="coach_name"
                                        placeholder="이름을 입력해주세요" maxlength="30"
                                        value="<?php echo isset($searchValue["coach_name"]) ? $searchValue["coach_name"] : ''; ?>">
                ...
                <div class="playerRegistrationBtnArea">
                    <div class="ExcelBtn IDBtn">
                        <button class="defaultBtn ID_Print BIG_btn2" type="button"
                            onclick="issueId('./entry_coach_issue.php','coach_id');" class="btn_view">ID발급</button>
                        ...
                        <form action="excel_to_db.php" method="post" enctype="multipart/form-data">
                            <input type="file" name="file" id="upload_coach" onchange="this.form.submit()" accept=".csv"
                                hidden />
                            <input type="text" name="role" value="coach" hidden />
                    ...
                    <div class="registrationBtn">
                        <button class="defaultBtn BIG_btn BTN_Blue" type="button"
                            onclick="createPopupWin('./entry_coach_input.php','등록', 1100, 900);">등록</button>
                    </div>
                </div>
                <div class="page">
