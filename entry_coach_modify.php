                    ...
                    <div class="UserProfile_modify coachArea Participant_img ptp_img">
                        ...
                        <div>
                            <ul class="UserDesc Participant_list">
                                ...
                                <li class="row">
                                    <span>이름</span>
                                    <input type="text" name="coach_second_name" id="coach_name"
                                        value="<?=$secondName?>" />
                                </li>
                                <li class="row">
                                    <span>성</span>
                                ...
                                <li class="row">
                                    <span>지역</span>
                                    <input type="text" name="coach_region" id="coach_region"
                                        value=<?=htmlspecialchars($row["coach_region"]) ?> />
                                </li>
                                <li class="row">
                                    <span>소속</span>
                                    <input type="text" name="coach_division" id="coach_division"
                                        value=<?php echo htmlspecialchars($row["coach_division"]) ?> />
                                </li>
                                <li class="row modify_input">
                                    <span>직무</span>
                                ...
                                <li class="row input_row row_item row_date">
                                    <span>생년월일</span>
                                    <input type="text" value=<?=htmlspecialchars($birth[0]) ?> name="coach_birth_year"
                                        placeholder="연">
                                    <input type="text" value=<?=htmlspecialchars($birth[1]) ?> name="coach_birth_month"
                                        placeholder="월">
                                    <input type="text" value=<?=htmlspecialchars($birth[2]) ?> name="coach_birth_day"
                                        placeholder="일">
                                </li>
                                <li class="row">
                                    <span>나이</span>
                                    <input type="text" name="coach_age" id="coach_age"
                                        value=<?php echo htmlspecialchars($row["coach_age"]) ?> />
                                </li>
                                <li class="row">
                                    <span>이미지 변경</span>
