            ...
            <div class="MainRank directorList defaultList">
                    ...
                    <form action="" name="director_searchForm" method="get" class="searchForm pageArea">
                        ...
                        <div class="selectArea defaultSelectArea">
                            ...
                            <div class="search">
                                ...
                                <input type="text" id="search" class="defaultSearchInput" name="director_name"
                                    placeholder="이름을 입력해주세요" maxlength="30"
                                    value="<?php echo isset($searchValue["director_name"]) ? $searchValue["director_name"] : ''; ?>">
                ...
                <table class="box_table">
                    <colgroup>
                        ...
                        <col width="auto">
                        <col width="auto">
                        <?if (authCheck($db, "authEntryUpdate")) {?>
                        <col width="auto">
                        <?}?>
                        <?if (authCheck($db, "authEntryUpdate")) {?>
                        <col width="auto">
                ...
                <div class="playerRegistrationBtnArea">
                    <div class="ExcelBtn IDBtn">
                        <button class="defaultBtn BIG_btn2 ID_Print" type="button"
                            onclick="issueId('./entry_director_issue.php','director_id');">ID발급</button>
                    ...
                    <div class="registrationBtn">
                        <button class="defaultBtn BIG_btn BTN_Blue" type="button"
                            onclick="createPopupWin('./entry_director_input.php','등록', 1100, 900);">등록</button>
                    </div>
                </div>
                <div class="page">
