            ...
            <div class="MainRank refereeList defaultList">
                    ...
                    <form action="" name="judge_searchForm" method="get" class="searchForm pageArea">
                        ...
                        <div class="selectArea defaultSelectArea">
                            ...
                            <div class="search">
                                ...
                                <input type="text" id="search" class="defaultSearchInput" name="judge_name" placeholder="이름을 입력해주세요" maxlength="30" value="<?php echo isset($searchValue["judge_name"]) ? $searchValue["judge_name"] : ''; ?>">
                ...
                <div class="playerRegistrationBtnArea">
                    <div class="ExcelBtn IDBtn">
                        <input type="button" onclick="issueId('./entry_judge_issue.php','judge_id');" value="ID발급" class="defaultBtn BIG_btn2 ID_Print">
                        ...
                        <button type="button" onclick="window.location.href='./assets/excel/judge_example.CSV'" class="defaultBtn excel_form BIG_btn2">엑셀 양식</button>
                    </div>
                    <div class="registrationBtn">
                        <input class="defaultBtn BIG_btn BTN_Blue" type="button" onclick="createPopupWin('./entry_judge_input.php','등록', 1100, 900);" value="등록">
                    </div>
                </div>
                <div class="page">
