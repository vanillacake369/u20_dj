...
<body>
    ...
    <div class="container">
        <div class="athlete">
            ...
            <div class="UserProfile">
                ...
                <form action="./action/module/judge_update.php" method="post" class="form"
                    enctype="multipart/form-data">
                    <div class="UserProfile_modify coachArea Participant_img ptp_img">
                        <div>
                            <img src=<? echo "./assets/img/judge_img/" . $row["judge_profile"] ?> alt="avatar"/>
                            ...
                            <ul class="UserDesc Participant_list">
                                ...
                                <li class="row" id="use_pw" style="display:none">
                                    ...
                                    <input type="password" name="judge_password" id="judge_password" value=""
                                        minlength="4" maxlength="20" placeholder="새로운 비밀번호를 입력해 주세요" />
                                </li>
                                <li class="row" id="use_pw_check" style="display:none">
                                    <span>비밀번호 재확인</span>
                                    <input type="password" name="cpassword" id="cpassword" value="" minlength="4"
                                        maxlength="20" placeholder="비밀번호를 다시 입력해 주세요" onkeyup="check();" />
                                </li>
                                <li class="row">
                                    <span>이름</span>
                                    <?php
                                ...
                                <li class="row">
                                    <span>소속</span>
                                    <input type="text" name="judge_division" id="judge_division"
                                        value=<?php echo htmlspecialchars($row["judge_division"]) ?> />
                                </li>
                                <li class="row modify_input">
                                    <span>직무</span>
                                    <select title="직무" name="judge_duty" id="judge_duty">
                                        <option value="judge" selected>심판</option>
                                    </select>
                                </li>
                                <li class="row modify_input">
                                    <span>성별</span>
                                ...
                                <li class="row input_row row_item row_date">
                                    ...
                                    <input type="text" value=<?php echo htmlspecialchars($birth[0]) ?>
                                        name="judge_birth_year" class="input_text_row_b" placeholder="연">
                                    <input type="text" value=<?php echo htmlspecialchars($birth[1]) ?>
                                        name="judge_birth_month" class="input_text_row_b" placeholder="월">
                                    <input type="text" value=<?php echo htmlspecialchars($birth[2]) ?>
                                        name="judge_birth_day" class="input_text_row_b" placeholder="일">
                                </li>
                                <li class="row">
                                    <span>나이</span>
                                    <input type="text" name="judge_age" id="judge_age"
                                        value=<?php echo htmlspecialchars($row["judge_age"]) ?> />
                                </li>
                                <li class="row">
                                    <span>이미지 변경</span>
                                    <input type="file" name="judge_imgFile" class="form-control" />
                                </li>
    ...
    <? require_once "action/module/judge_modify_selected.php"; ?>
</body>
