            ...
            <form action="../action/record/track_normal_result_insert.php" method="post">
                ...
                formaction="/action/record/three_try_after_reverse.php">순서 재정렬</button>';
                    ...
                    <div class="modify_Btn input_Btn result_Btn">
                        <?php
                        if ($rows["record_state"] != "y") {
                            echo '<div class="signup_submit" id="submit_div_gwoan_san">
                <button type="submit" class=" BTN_Red " name="addtempresult"
                    ...
                    <span>확인</span>
                            ...
                            if (authCheck($db, "authSchedulesUpdate")) {  ?>
                                <div class="signup_submit" id="submit_div_gwoan_san" style="width:100%;">
                                    <button type="submit" class="BTN_Blue " name="addresult" formaction="../action/record/field_normal_result_insert.php">
                                        <span>확인</span>
                                    </button>
                                </div>
