...
<body>
    <div class="page">
            ...
            <table width="100%" cellspacing="0" cellpadding="0" class="table table-hover team_table">
                <tr>
                    ...
                    <td style="text-align: right"><img style="width: 80px; height: 40px"
                            src="<?php echo $_SERVER['REQUEST_SCHEME'] . '://' . $_SERVER['SERVER_NAME'] . "/assets/images/logo.png" ?>"
        ...
        $sql = "select schedule_location,schedule_sports,schedule_gender, schedule_date from list_schedule where schedule_sports = '" . $_POST['schedule_sports'] . "' and schedule_status='y' and schedule_round='" . $_POST['round'] . "'";
        $result = $db->query($sql);
