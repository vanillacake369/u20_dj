...
<body>
    <div class="page">
        <div class="top">
            <table width="100%" cellspacing="0" cellpadding="0" class="table table-hover team_table">
                <tr>
                    ...
                    <td style="text-align: right"><img style="width: 80px; height: 40px" src="<?php echo $_SERVER['REQUEST_SCHEME'] . '://' . $_SERVER['SERVER_NAME'] . "/assets/images/logo.png" ?>" alt="Logo" class="logo_img" /></td>
                </tr>
            </table>
        </div>
        ...
        <div class="middle" style="display:inline-block">
            ...
            $sql = "select schedule_location,schedule_sports,schedule_gender, schedule_date from list_schedule where schedule_sports = '" . $row['schedule_sports'] . "' and schedule_status='y' and schedule_round='" . $row['schedule_round'] . "'";
            $result = $db->query($sql);
            ...
            <table width="100%" cellspacing="0" cellpadding="0" class="table table-hover team_table">
                ...
                <tr>
                    <?php
                    echo '<td><p style="font-size:12px; width:330px; margin-bottom: 1em">라운드: ' . $_POST['schedule_round'] . '</p></td>';
                    echo '<td><p style="font-size:12px; width:330px; margin-bottom: 1em">용기구: ' . $_POST['weight'] . 'KG</p></td>';
                    ?>
                </tr>
            </table>
