      ...
      <div class="UserProfile">
        ...
        <form action="#" method="post">
            ...
            <div>
              <ul class="UserDesc throwDesc">
                <li class="row input_row throw_row">
                  <span>경기 이름</span>
                  <input placeholder="경기 이름" type="text" name="gamename" value="<?= $rows['schedule_name'] ?>" maxlength="16" required="" readonly />
                </li>
                <li class="row input_row throw_row">
                  <span>라운드</span>
                  <?php
          ...
          <table class="box_table">
            ...
            while ($row = mysqli_fetch_array($result)) {
              ...
              if (($row['record_new'] && null) == 'y') {
                ...
                console_log('하이');
                console_log($row['athlete_name']);
                console_log($sport_code);
                console_log($time);
                console_log($athletics);
          ...
          <div class="modify_Btn input_Btn result_Btn">
            <?php
            if ($rows["record_state"] != "y") {
              echo '<div class="signup_submit" id="submit_div_gwoan_san" style="width:49%">
              ...
              if (authCheck($db, "authSchedulesUpdate")) {  ?>
                <div class="modify_Btn input_Btn result_Btn signup_submit" id="submit_div_gwoan_san">
                  <button type="submit" class="BTN_Blue full_width" name="addresult" formaction="../action/record/field_vertical_result_insert.php">
                    <span>확인</span>
                  </button>
                </div>
