...
<body>
    <div class="container">
                        ...
                        <div>
                            <ul class="UserDesc throwDesc">
                                <li class="row input_row throw_row">
                                    <span>경기 이름</span>
                                    <input placeholder="경기 이름" type="text" name="gamename" value="<?php echo $rows['schedule_name'] ?>" maxlength="16" required="" readonly />
                                </li>
                                <li class="row input_row throw_row">
                                    <span>라운드</span>
                                    <?php
        ...
        <input placeholder="비고를 입력해주세요." type="text" name="bibigo" class="note_text" value="<?php echo ($rows['schedule_memo'] ?? null) ?>" maxlength=" 100" />
        <div class="modify_Btn input_Btn result_Btn">
            ...
            if ($rows["record_state"] != "y") {
                ...
                if (authCheck($db, "authSchedulesUpdate")) {  ?>
                    <div class="modify_Btn input_Btn result_Btn">
                        <button type="submit" class="BTN_Blue full_width" name="addresult" formaction="../action/record/track_relay_result_insert.php">
                            <span>확인</span>
                        </button>
                    </div>
