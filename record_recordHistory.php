                    ...
                    <form action="" name="judge_searchForm" method="get" class="searchForm pageArea">
                        <div class="page_size">
                            <select name="entry_size" onchange="changeTableSize(this);" id="changePageSize" class="changePageSize">
                                ...
                                <?php
                                    $get_worldrecord_count_sql = "SELECT COUNT(*) AS worldrecord_count FROM list_worldrecord;";
                                    $worldrecord_count_result = $db->query($get_worldrecord_count_sql);
                                    $worldrecord_count_row = mysqli_fetch_array($worldrecord_count_result);
                                    $size_of_all = $worldrecord_count_row["worldrecord_count"];
