<?
  ...
  $sql_where = "";
  $sql_order = "ORDER BY schedule_end desc";
  $sql_like = "";
  ...
  $athletics = ["세계신기록", "세계U20신기록", "아시아신기록", "아시아U20신기록", "대회신기록"];
  /**
   * 2. 검색값 입력 시,
  ...
  if ($hasSearched) {
    ...
    if ($hasSearchedDate) {
      ...
      array_push($keyword, "schedule_end like ?");
    }
                        ...
                        <div class="selectArea defaultSelectArea">
                            <div class="defaultSelectBox">
                                <select title="날짜" name="schedule_date">
                                    ...
                                    <?php
                                      $dSql = "SELECT DISTINCT (SUBSTRING_INDEX(schedule_end, ' ', 1)) AS a FROM list_schedule WHERE schedule_end is not null ORDER BY a ASC;";
                ...
                <table class="box_table">
                  ...
                  <thead class="table_head entry_table">
                    <tr>
                      ...
                      <th><a href="<?= Get_Sort_Link("schedule_result", $pageValue, $link, $orderValue) ?>">기록 방식
                      </th>
                  ...
                  <?php
                    ...
                    // 날짜
                    echo "<td>" . htmlspecialchars($row["schedule_end"]) . "</td>";
                    // 구분
                ...
                <div class="playerRegistrationBtnArea">
                    <div class="ExcelBtn IDBtn">
                        <form action="./execute_excel.php" method="post" enctype="multipart/form-data">
                            <input type="submit" name="query" id="execute_excel" value="<?php echo $sql.$sql_order; ?>"
                                hidden />
                    ...
                    <div class="registrationBtn">
                        <button type="button" class="defaultBtn BIG_btn BTN_Blue" onclick="changetype()">기록전환</button>
                    </div>
                </div>
                <div class="page">
