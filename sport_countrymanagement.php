                ...
                <div class="searchArea">
                    <form action="" name="director_searchForm" method="get" class="searchForm pageArea">
                        ...
                        <div class="selectArea defaultSelectArea">
                            <div class="search">
                                <input type="text" id="search_country" class="defaultSearchInput" name="search_country"
                    ...
                    <thead class="table_head entry_table">
                        <tr>
                            ...
                            <th colspan="5" scope="col"><a
                                    href="<?= Get_Sort_Link("name", $pageValue, $link, $orderValue) ?>">국가
                                    이름(ENG)</a></th>
                            <th colspan="4" scope="col"><a
                                    href="<?= Get_Sort_Link("name_kr", $pageValue, $link, $orderValue) ?>">국가
                                    이름(KOR)</a></th>
                            <th colspan="4" scope="col"><a
                                    href="<?= Get_Sort_Link("code", $pageValue, $link, $orderValue) ?>">국가 코드</a>
                            </th>
                ...
                <div class="playerRegistrationBtnArea">
                    ...
                    <div class="registrationBtn">
                        ...
                        <button class="defaultBtn BIG_btn BTN_Blue" type="button"
                            onclick="createPopupWin('sport_country_input.php','창 이름',900,900)">등록</button>
                        <? } ?>
                    </div>
                </div>
                <div class="page">
