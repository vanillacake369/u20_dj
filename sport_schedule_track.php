                    ...
                    <div class="filed_BTN">
                        <div>
                            ...
                            <button type="submit" class="defaultBtn BIG_btn BTN_Red filedBTN"
                                formaction="/record/track_<?php if ($schedule_sports == '4x400mR' || $schedule_sports == '4x100mR') echo 'relay';
