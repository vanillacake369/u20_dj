...
<body>
    <div class="schedule_container">
                    ...
                    <div class="filed_BTN">
                        <div>
                            ...
                            <button type="submit" class="defaultBtn BIG_btn BTN_Red filedBTN" formaction="/record/track_<?php if ($schedule_sports == '4x400mR' || $schedule_sports == '4x100mR') echo 'relay';
                                                                                                                        else echo 'normal'; ?>_result_pdf.php">PDF(한)
                                출력</button>
                            <button type="submit" class="defaultBtn BIG_btn BTN_Red filedBTN" formaction="/record/track_<?php if ($schedule_sports == '4x400mR' || $schedule_sports == '4x100mR') echo 'relay';
                ...
                <div class="schedule_filed filed_list_item filed_container">
                    ...
                    <form action="#" method="post" class="form">
                        <table class="box_table">
                            ...
                            <tr>
                                <td><input type="number" name="rain[]" value="<?php echo htmlspecialchars($row['record_order']) ?>" min="1" required="" readonly />
                                </td>
                                <td><input type="number" name="rank[]" value="<?php echo ($row['record_status'] == 'o') ? htmlspecialchars($row['record_official_result']) : htmlspecialchars($row['record_live_result']) ?>" min="1" /></td>
                                <td><input placeholder="등번호" type="text" name="playerbib[]" value="<?php echo htmlspecialchars($row['athlete_bib']) ?>" maxlength="30" required="" readonly />
                                </td>
                                <td><input placeholder="선수 이름" type="text" name="playername[]" value="<?php echo htmlspecialchars($row['athlete_name']) ?>" maxlength="30" required="" readonly />
                                </td>
                                <td><input placeholder="경기 결과" type="text" name="gameresult[]" value="<?php echo ($row['record_status'] == 'o') ? htmlspecialchars($row['record_official_record']) : htmlspecialchars($row['record_live_record']) ?>" onkeyup="trackResultForm(this)" style="" /></td>
                                <td><input placeholder="경기 결과" type="text" name="reactiontime[]" value="<?php echo htmlspecialchars($row['record_reaction_time']) ?>" onkeyup="trackReactionTimeForm(this)" style="" /></td>
                                <td><input placeholder="비고" type="text" name="bigo[]" value="<?php echo  htmlspecialchars($row['record_memo']) ?>" maxlength="100" /></td>
                                <?php
        ...
        ?>
            <button type="button" class="nextBTN BTN_blue2 defaultBtn" onclick="window.open('/sport_schedule_group_next.php?<?php echo 'sports=' . $sports . '&gender=' . $gender . '&round=' . $round . '\'' ?>, 'window_name', 'width=800, height=750, location=no, status=no, scrollbars=yes')">
                다음 조 편성
            </button>
        <?php }
        if (!in_array($schedule_round, ["preliminary-round", "qualification"]) && $row2['record_status'] === 'n') {
