                    ...
                    <table class="table table-hover team_table">
                        ...
                        <div class="selectArea float_l">
                            <form action="./execute_excel.php" method="post" enctype="multipart/form-data">
                                ...
                                <label for="execute_excel" class="btn_excel label_for_excel_import bold float_l">엑셀출력</label>
                            </form>
                        </div>
                        ...
                        <form action="" enctype="multipart/form-data" class="searchForm" name="judge_searchForm" method="get" style="display: flex; flex-wrap: wrap; align-items: center; justify-content: flex-end;">
                            ...
                            <div class="selectArea float_r">
                                ...
                                <div class="search" style="width: 50px">
                                    <button name="search" value="search" type="submit" class="btn_search" title="검색"></button>
                                </div>
                ...
                <div class="selectArea float_r">
                    ...
                    if (authCheck($db, "authSchedulesCreate")) { ?>
                        <div class="btn_base base_mar col_right">
                            <input class="btn_add btn_txt bold" type="button" onclick="createPopupWin('sport_sport_input.php','창 이름',900,512)" value="등록" class="btn_view">
                        </div>
                    <?php } ?>
                    <colgroup>
                        <col width="auto" />
